export const PostgresVisual = () => (
  <svg
    ...
    className="absolute top-1/2 -right-2 origin-right -translate-y-1/2 text-neutral-200/75 transition-colors *:ease-in *:group-hover:duration-500 dark:text-neutral-800"
  >
    <path
      ...
      className="group-hover:text-blue-200 dark:group-hover:text-blue-900"
    />
    <path
